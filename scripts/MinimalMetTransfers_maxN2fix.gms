...
obj_maxN2fix ..     z =e= v('rxn06874[ucyn]');

max_org_trans_cons..		sum(j$(org_trans(j)), ytrans(j)) =l= max_org_trans ;
maxN2fix_cons..				v('rxn06874[ucyn]') =g= maxN2fix;
...
FILE resultfile /"%out_path%FindHost2UCYNtransfer_maxUCYNn2fix.txt"/;
...
Solve maximizeN2fix using mip maximizing z;
maxN2fix.fx = z.l;
put "maximal N2-fixation flux: ",z.l:0:10,"  ",maximizeN2fix.modelstat//;
